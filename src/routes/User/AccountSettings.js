    ...
    const bindMobile = <div>
      <Tabs activeKey={mobileActiveKey} tabBarStyle={{display: 'none'}}>
        <TabPane tab="Tab 1" key="1">
          ...
          <Form.Item {...tailFormItemLayout}>
            <Button type="primary" onClick={() => this.preMatchCaptcha('originMobile', 'originCaptcha')}>下一步</Button>
          </Form.Item>
        </TabPane>
    ...
    return (
      <div>
        ...
        >
          ...
          <TabPane tab={<span><Icon type="lock" />账户安全</span>} key="2">
            <Card title="账户安全" bordered={false} bodyStyle={{padding: 0}}>
              ...
              <Row className={styles.rowStyle}>
                ...
                <Col span={3} style={{textAlign: 'center'}}>
                  {currentUser.mobile
                    ? <span><a href="javascript:;" onClick={() => this.showModal('bindMobile')}>修改</a></span>
              ...
              <Row className={styles.rowStyle}>
                ...
                <Col span={3} style={{textAlign: 'center'}}>
                  {currentUser.email
                    ? <span><a href="javascript:;" onClick={() => this.showModal('bindEmail')}>修改</a></span>
          ...
          <TabPane tab={<span><Icon type="lock" />会话管理</span>} key="3">Content of tab 3</TabPane>
